...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    wasmTable = wasmExports["Fi"];
    addOnInit(wasmExports["Ai"]);
...
var wasmImports = {
  zi: _PokiSdkJs_AddParameterForURL,
  yi: _PokiSdkJs_CaptureError,
  xi: _PokiSdkJs_CommercialBreak,
  wi: _PokiSdkJs_GameplayStart,
  vi: _PokiSdkJs_GameplayStop,
  ui: _PokiSdkJs_GetURLParam,
  ti: _PokiSdkJs_InternalCaptureError,
  si: _PokiSdkJs_IsAdBlocked,
  ri: _PokiSdkJs_RewardedBreak,
  qi: _PokiSdkJs_SetDebug,
  pi: _PokiSdkJs_ShareableURL,
  b: ___assert_fail,
  oi: ___syscall__newselect,
  ni: ___syscall_accept4,
  mi: ___syscall_bind,
  li: ___syscall_connect,
  ki: ___syscall_dup3,
  f: ___syscall_fcntl64,
  ji: ___syscall_getpeername,
  ii: ___syscall_getsockname,
  $: ___syscall_getsockopt,
  hi: ___syscall_ioctl,
  gi: ___syscall_listen,
  fi: ___syscall_mkdirat,
  _: ___syscall_openat,
  ei: ___syscall_poll,
  di: ___syscall_readlinkat,
  ci: ___syscall_recvfrom,
  bi: ___syscall_renameat,
  ai: ___syscall_rmdir,
  $h: ___syscall_sendto,
  xa: ___syscall_socket,
  _h: ___syscall_stat64,
  ...
  zh: _emscripten_glBindBuffer,
  yh: _emscripten_glBindBufferBase,
  xh: _emscripten_glBindBufferRange,
  wh: _emscripten_glBindFramebuffer,
  vh: _emscripten_glBindRenderbuffer,
  uh: _emscripten_glBindSampler,
  th: _emscripten_glBindTexture,
  sh: _emscripten_glBindTransformFeedback,
  rh: _emscripten_glBindVertexArray,
  qh: _emscripten_glBindVertexArrayOES,
  ph: _emscripten_glBlendColor,
  oh: _emscripten_glBlendEquation,
  nh: _emscripten_glBlendEquationSeparate,
  mh: _emscripten_glBlendFunc,
  lh: _emscripten_glBlendFuncSeparate,
  kh: _emscripten_glBlitFramebuffer,
  jh: _emscripten_glBufferData,
  ih: _emscripten_glBufferSubData,
  hh: _emscripten_glCheckFramebufferStatus,
  gh: _emscripten_glClear,
  fh: _emscripten_glClearBufferfi,
  eh: _emscripten_glClearBufferfv,
  dh: _emscripten_glClearBufferiv,
  ch: _emscripten_glClearBufferuiv,
  bh: _emscripten_glClearColor,
  ah: _emscripten_glClearDepthf,
  $g: _emscripten_glClearStencil,
  _g: _emscripten_glClientWaitSync,
  ...
  zg: _emscripten_glDepthFunc,
  yg: _emscripten_glDepthMask,
  xg: _emscripten_glDepthRangef,
  wg: _emscripten_glDetachShader,
  vg: _emscripten_glDisable,
  ug: _emscripten_glDisableVertexAttribArray,
  tg: _emscripten_glDrawArrays,
  sg: _emscripten_glDrawArraysInstanced,
  rg: _emscripten_glDrawArraysInstancedANGLE,
  qg: _emscripten_glDrawArraysInstancedARB,
  pg: _emscripten_glDrawArraysInstancedEXT,
  og: _emscripten_glDrawArraysInstancedNV,
  ng: _emscripten_glDrawBuffers,
  mg: _emscripten_glDrawBuffersEXT,
  lg: _emscripten_glDrawBuffersWEBGL,
  kg: _emscripten_glDrawElements,
  jg: _emscripten_glDrawElementsInstanced,
  ig: _emscripten_glDrawElementsInstancedANGLE,
  hg: _emscripten_glDrawElementsInstancedARB,
  gg: _emscripten_glDrawElementsInstancedEXT,
  fg: _emscripten_glDrawElementsInstancedNV,
  eg: _emscripten_glDrawRangeElements,
  dg: _emscripten_glEnable,
  cg: _emscripten_glEnableVertexAttribArray,
  bg: _emscripten_glEndQuery,
  ag: _emscripten_glEndQueryEXT,
  $f: _emscripten_glEndTransformFeedback,
  _f: _emscripten_glFenceSync,
  ...
  If: _emscripten_glGetActiveAttrib,
  ...
  zf: _emscripten_glGetBufferParameteriv,
  yf: _emscripten_glGetError,
  xf: _emscripten_glGetFloatv,
  wf: _emscripten_glGetFragDataLocation,
  vf: _emscripten_glGetFramebufferAttachmentParameteriv,
  uf: _emscripten_glGetInteger64i_v,
  tf: _emscripten_glGetInteger64v,
  sf: _emscripten_glGetIntegeri_v,
  rf: _emscripten_glGetIntegerv,
  qf: _emscripten_glGetInternalformativ,
  pf: _emscripten_glGetProgramBinary,
  of: _emscripten_glGetProgramInfoLog,
  nf: _emscripten_glGetProgramiv,
  mf: _emscripten_glGetQueryObjecti64vEXT,
  lf: _emscripten_glGetQueryObjectivEXT,
  kf: _emscripten_glGetQueryObjectui64vEXT,
  jf: _emscripten_glGetQueryObjectuiv,
  hf: _emscripten_glGetQueryObjectuivEXT,
  gf: _emscripten_glGetQueryiv,
  ff: _emscripten_glGetQueryivEXT,
  ef: _emscripten_glGetRenderbufferParameteriv,
  df: _emscripten_glGetSamplerParameterfv,
  cf: _emscripten_glGetSamplerParameteriv,
  bf: _emscripten_glGetShaderInfoLog,
  af: _emscripten_glGetShaderPrecisionFormat,
  $e: _emscripten_glGetShaderSource,
  ...
  ze: _emscripten_glIsRenderbuffer,
  ye: _emscripten_glIsSampler,
  xe: _emscripten_glIsShader,
  we: _emscripten_glIsSync,
  ve: _emscripten_glIsTexture,
  ue: _emscripten_glIsTransformFeedback,
  te: _emscripten_glIsVertexArray,
  se: _emscripten_glIsVertexArrayOES,
  re: _emscripten_glLineWidth,
  qe: _emscripten_glLinkProgram,
  pe: _emscripten_glPauseTransformFeedback,
  oe: _emscripten_glPixelStorei,
  ne: _emscripten_glPolygonOffset,
  me: _emscripten_glProgramBinary,
  le: _emscripten_glProgramParameteri,
  ke: _emscripten_glQueryCounterEXT,
  ...
  ee: _emscripten_glResumeTransformFeedback,
  de: _emscripten_glSampleCoverage,
  ce: _emscripten_glSamplerParameterf,
  be: _emscripten_glSamplerParameterfv,
  ae: _emscripten_glSamplerParameteri,
  $d: _emscripten_glSamplerParameteriv,
  _d: _emscripten_glScissor,
  ...
  zd: _emscripten_glUniform2fv,
  yd: _emscripten_glUniform2i,
  xd: _emscripten_glUniform2iv,
  wd: _emscripten_glUniform2ui,
  vd: _emscripten_glUniform2uiv,
  ud: _emscripten_glUniform3f,
  td: _emscripten_glUniform3fv,
  sd: _emscripten_glUniform3i,
  rd: _emscripten_glUniform3iv,
  qd: _emscripten_glUniform3ui,
  pd: _emscripten_glUniform3uiv,
  od: _emscripten_glUniform4f,
  nd: _emscripten_glUniform4fv,
  md: _emscripten_glUniform4i,
  ld: _emscripten_glUniform4iv,
  kd: _emscripten_glUniform4ui,
  jd: _emscripten_glUniform4uiv,
  id: _emscripten_glUniformBlockBinding,
  hd: _emscripten_glUniformMatrix2fv,
  gd: _emscripten_glUniformMatrix2x3fv,
  fd: _emscripten_glUniformMatrix2x4fv,
  ed: _emscripten_glUniformMatrix3fv,
  dd: _emscripten_glUniformMatrix3x2fv,
  cd: _emscripten_glUniformMatrix3x4fv,
  bd: _emscripten_glUniformMatrix4fv,
  ad: _emscripten_glUniformMatrix4x2fv,
  $c: _emscripten_glUniformMatrix4x3fv,
  _c: _emscripten_glUseProgram,
  ...
  X: _emscripten_set_main_loop_arg,
  ...
  kc: _glDrawElements,
  jc: _glEnable,
  ic: _glEnableVertexAttribArray,
  hc: _glFlush,
  gc: _glFramebufferRenderbuffer,
  fc: _glFramebufferTexture2D,
  ec: _glFrontFace,
  oa: _glGenBuffers,
  dc: _glGenFramebuffers,
  A: _glGenRenderbuffers,
  na: _glGenTextures,
  cc: _glGetActiveAttrib,
  bc: _glGetActiveUniform,
  ac: _glGetAttribLocation,
  c: _glGetError,
  $b: _glGetFloatv,
  z: _glGetIntegerv,
  ...
  e: invoke_viiii,
  q: invoke_viiiii,
  bb: _js_addBusinessEvent,
  ab: _js_addDesignEvent,
  $a: _js_addDesignEventWithValue,
  _a: _js_addErrorEvent,
  Za: _js_addProgressionEvent,
  Ya: _js_addProgressionEventWithScore,
  Xa: _js_addResourceEvent,
  Wa: _js_configureAvailableCustomDimensions01,
  Va: _js_configureAvailableCustomDimensions02,
  Ua: _js_configureAvailableCustomDimensions03,
  Ta: _js_configureAvailableResourceCurrencies,
  Sa: _js_configureAvailableResourceItemTypes,
  Ra: _js_configureBuild,
  Qa: _js_configureGameEngineVersion,
  Pa: _js_configureSdkGameEngineVersion,
  Oa: _js_configureUserId,
  Na: _js_endSession,
  Ma: _js_getRemoteConfigsContentAsString,
  La: _js_getRemoteConfigsValueAsStringWithDefaultValue,
  P: _js_initialize,
  Ka: _js_isRemoteConfigsReady,
  Ja: _js_setCustomDimension01,
  Ia: _js_setCustomDimension02,
  Ha: _js_setCustomDimension03,
  da: _js_setEnabledInfoLog,
  ca: _js_setEnabledVerboseLog,
  ba: _js_setEventSubmission,
  Ga: _js_setGlobalCustomEventFields,
  aa: _js_setManualSessionHandling,
  Fa: _js_startSession,
  a: wasmMemory,
  ya: _strftime
};
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Ai"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Bi"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Ci"])(a0, a1);
};
...
var _js_remote_configs_callback = Module["_js_remote_configs_callback"] = function () {
  return (_js_remote_configs_callback = Module["_js_remote_configs_callback"] = wasmExports["Gi"])();
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["Hi"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["Ii"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["Ji"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["Ki"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["Li"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["Mi"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["Ni"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["Oi"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["Pi"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["Qi"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["Ri"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["Si"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["Ti"])(a0, a1);
};
